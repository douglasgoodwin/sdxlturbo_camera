...
default_prompt = "Watercolor of a stormy sea, gray sky, muted colour, cinematic lighting, painterly, loose, detailed, masterpiece"
page_content = """
...
<p class="text-sm">
Real-Time SDv2.1 Turbo pipeline with Image-to-Image ControlNet
</p>
"""
