...
default_prompt = "Watercolor of bright showy flowers by LeRoy Neiman, bright colour, cinematic lighting, painterly, loose, detailed, masterpiece"
default_negative_prompt = "blurry, low quality, render, 3D, oversaturated, bodies, waifu"
page_content = """
<h1 class="text-3xl font-bold">Another Gloomy Sunday | Doug Goodwin</h1>
<h3 class="text-xl font-bold">Demo for CalArts AI X Practice symposium</h3>
<p class="text-sm">
Real-Time Latent Consistency Model SDXL pipeline with SDXL + LCM + LoRA + Controlnet
</p>
"""
